...
export default function AddTaskPage({ adminMode = false }) {
  ...
  async function submit(event) {
    ...
    try {
      ...
      setTimeout(() => window.location.replace(adminMode ? "/admin-tasks.html" : "/tasks.html"), 550);
