...
export default function AdminLoginPage() {
  ...
  if (user?.role === "admin") return <Navigate to="/admin-dashboard.html" replace />;
  ...
  return <main className="admin-login-page">
    <section className="admin-login-card">
      ...
      <Link to="/login.html" reloadDocument><Icon name="chevron" size={16} className="back-icon" />Return to member login</Link>
    </section>
  </main>;
}
