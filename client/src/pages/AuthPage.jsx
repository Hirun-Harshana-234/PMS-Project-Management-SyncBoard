...
export default function AuthPage() {
  ...
  if (user) return <Navigate to={user.role === "admin" ? "/admin-dashboard.html" : "/home.html"} replace />;
  ...
  async function submit(event) {
    ...
    try {
      ...
      window.location.replace(location.state?.from?.pathname || "/home.html");
