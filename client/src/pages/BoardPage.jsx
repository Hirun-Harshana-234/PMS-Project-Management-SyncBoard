...
export default function BoardPage() {
  ...
  return <>
    ...
    <section className="workspace-layout">
      ...
      <aside className="activity-rail"><header><div><span className="live-dot" />Live activity</div><Link to="/activity.html">View all</Link></header><ActivityList activities={activities.slice(0, 7)} compact /></aside>
    </section>
