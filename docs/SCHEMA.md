...
| --- | --- |
| `users` | Name, username, email, password hash, system role, project job title, department, progress, active state, avatar color/photo, refresh-token hashes, last seen, timestamps |
...
| `messages` | Board, sender, recipient, message/help body, read state, and timestamps |
