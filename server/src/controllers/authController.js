...
const { validateRegistration, validateProfileImage, emailPattern, pick, requiredString } = require("../utils/validation");
...
async function updateProfile(req, res) {
  const changes = pick(req.body, ["displayName", "email", "avatarColor", "avatarData"]);
  ...
  if (changes.avatarData !== undefined) changes.avatarData = validateProfileImage(changes.avatarData);
