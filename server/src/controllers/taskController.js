...
async function createTask(req, res) {
  ...
  await syncMemberProgress(req.board._id, task.assignee);
...
async function updateTask(req, res) {
  ...
  const previousAssignee = before.assignee;
  ...
  await syncMemberProgress(req.board._id, previousAssignee);
  await syncMemberProgress(req.board._id, updated.assignee);
  const output = mapTask(await populatedTask(updated._id));
