...
const userSchema = new mongoose.Schema({
  ...
  avatarColor: { type: String, default: "#3d73ff" },
  // The client resizes profile photos before storing the data URL here.
  avatarData: { type: String, default: "", maxlength: 500000 },
