...
router.get("/:boardId/messages", loadBoard, asyncHandler(message.listMessages));
router.post("/:boardId/messages", loadBoard, asyncHandler(message.createMessage));
router.patch("/:boardId/messages/:messageId/read", loadBoard, asyncHandler(message.markRead));
