...
function mapMessage(message) {
  ...
  return {
    id: (value._id || value.id).toString(),
    boardId: value.board?._id ? value.board._id.toString() : value.board?.toString(),
    sender: value.sender?._id ? mapUser(value.sender) : value.sender?.toString(),
    recipient: value.recipient?._id ? mapUser(value.recipient) : value.recipient?.toString(),
    body: value.body,
...
module.exports = { mapUser, mapBoard, mapTask, mapMessage };
